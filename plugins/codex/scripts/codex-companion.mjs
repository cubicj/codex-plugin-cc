...
function printUsage() {
  console.log(
    [
      ...
      "  node scripts/codex-companion.mjs task [--background] [--write] [--read-only] [--resume-last|--resume|--resume-thread <id>|--fresh] [--model <model|spark>] [--effort <none|minimal|low|medium|high|xhigh>] [prompt]",
