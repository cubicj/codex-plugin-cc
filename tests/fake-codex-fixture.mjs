  ...
  try {
    switch (message.method) {
      ...
      case "thread/start": {
        ...
        send({ id: message.id, result: { thread: buildThread(thread), model: message.params.model || "gpt-5.4", modelProvider: "openai", serviceTier: null, cwd: thread.cwd, approvalPolicy: "never", sandbox, reasoningEffort: BEHAVIOR === "resolved-effort" ? "medium" : null } });
